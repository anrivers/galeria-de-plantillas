    ...
    return (
      ...
      <div className="about-content">
        <div className="about-section">
          <img src="images/estructura-web.png" alt="Nuestra Misión" className="about-image"/>
        ...
        <div className="about-section reverse">
          <img src="images/estructura-web.png" alt="Nuestro Equipo" className="about-image"/>
          <div className="about-text">
        ...
        <div className="about-section">
          <img src="images/estructura-web.png" alt="Nuestros Valores" className="about-image"/>
          <div className="about-text">
