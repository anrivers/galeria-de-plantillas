        ...
        <div className={`lg:w-1/4 ${showStyles ? 'block' : 'hidden lg:block'}`}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <label className="flex items-center gap-2">
              ...
              <input type="color" onChange={(e) => applyStyle('.btn1, .btn2, .login, .all-btn, .header .navbar .btn, .home .content .home-btn, .input_container button, .section1__buttonContainer button, .social__links_container button, .btn-secondary, .btn-primary, .btn-outline, .btn', 'background-color', e.target.value)} className="w-12 h-8 border rounded" />
            </label>
          </div>
